...
public class CraftingTierTriridium {

	private static final CraftingTierTriridium instance = new CraftingTierTriridium();
	public ArrayList<RecipeCatalyst> recipes = new ArrayList<RecipeCatalyst>();
	
	public CraftingTierTriridium(){
	...
	public static ItemStack getMatchingRecipeResult(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierBiridium.getMatchingRecipeResult(ingredients);
	}
	...
	public static IRecipe getMatchingRecipe(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierBiridium.getMatchingRecipe(ingredients);
	}
	...
	public static CraftingTierTriridium getInstance(){
		return instance;
	}
