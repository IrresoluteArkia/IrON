...
public class CraftingTierSextridium {

	private static final CraftingTierSextridium instance = new CraftingTierSextridium();
	public ArrayList<RecipeCatalyst> recipes = new ArrayList<RecipeCatalyst>();
	
	public CraftingTierSextridium(){
	...
	public static ItemStack getMatchingRecipeResult(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierQuintridium.getMatchingRecipeResult(ingredients);
	}
	...
	public static IRecipe getMatchingRecipe(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierQuintridium.getMatchingRecipe(ingredients);
	}
	...
	public static CraftingTierSextridium getInstance(){
		return instance;
	}
