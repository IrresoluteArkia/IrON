...
public class ContainerCatalystTierSextridium extends Container{

	private ItemCatalyst.CatalystCraftingInventory cci;
	
	public ContainerCatalystTierSextridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci){
