...
public class CraftingTierDecadrium {

	private static final CraftingTierDecadrium instance = new CraftingTierDecadrium();
	public ArrayList<RecipeCatalyst> recipes = new ArrayList<RecipeCatalyst>();
	
	public CraftingTierDecadrium(){
	...
	public static ItemStack getMatchingRecipeResult(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierNonadium.getMatchingRecipeResult(ingredients);
	}
	...
	public static IRecipe getMatchingRecipe(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierNonadium.getMatchingRecipe(ingredients);
	}
	...
	public static CraftingTierDecadrium getInstance(){
		return instance;
	}
