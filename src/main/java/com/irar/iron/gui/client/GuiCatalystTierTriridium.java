...
public class GuiCatalystTierTriridium extends GuiContainer {

	private IInventory playerInv;
	private ItemCatalyst.CatalystCraftingInventory cci;

	public GuiCatalystTierTriridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci) {
	    super(new ContainerCatalystTierTriridium(playerInv, cci));
