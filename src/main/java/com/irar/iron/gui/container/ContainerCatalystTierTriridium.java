...
public class ContainerCatalystTierTriridium extends Container{

	private ItemCatalyst.CatalystCraftingInventory cci;
	
	public ContainerCatalystTierTriridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci){
