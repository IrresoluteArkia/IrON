...
public class GuiCatalystTierSextridium extends GuiContainer {

	private IInventory playerInv;
	private ItemCatalyst.CatalystCraftingInventory cci;

	public GuiCatalystTierSextridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci) {
	    super(new ContainerCatalystTierSextridium(playerInv, cci));
