...
public class ContainerCatalystTierDecadrium extends Container{

	private ItemCatalyst.CatalystCraftingInventory cci;
	
	public ContainerCatalystTierDecadrium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci){
