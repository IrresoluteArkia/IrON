...
public class CraftingTierBiridium {

	private static final CraftingTierBiridium instance = new CraftingTierBiridium();
	public ArrayList<RecipeCatalyst> recipes = new ArrayList<RecipeCatalyst>();
	
	public CraftingTierBiridium(){
	...
	public static ItemStack getMatchingRecipeResult(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierIridium.getMatchingRecipeResult(ingredients);
	}
	...
	public static IRecipe getMatchingRecipe(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierIridium.getMatchingRecipe(ingredients);
	}
	...
	public static CraftingTierBiridium getInstance(){
		return instance;
	}
