...
public class ContainerCatalystTierOctridium extends Container{

	private ItemCatalyst.CatalystCraftingInventory cci;
	
	public ContainerCatalystTierOctridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci){
