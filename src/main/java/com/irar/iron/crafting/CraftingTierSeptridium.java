...
public class CraftingTierSeptridium {

	private static final CraftingTierSeptridium instance = new CraftingTierSeptridium();
	public ArrayList<RecipeCatalyst> recipes = new ArrayList<RecipeCatalyst>();
	
	public CraftingTierSeptridium(){
	...
	public static ItemStack getMatchingRecipeResult(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierSextridium.getMatchingRecipeResult(ingredients);
	}
	...
	public static IRecipe getMatchingRecipe(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierSextridium.getMatchingRecipe(ingredients);
	}
	...
	public static CraftingTierSeptridium getInstance(){
		return instance;
	}
