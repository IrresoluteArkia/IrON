...
public class GuiCatalystTierQuintridium extends GuiContainer {

	private IInventory playerInv;
	private ItemCatalyst.CatalystCraftingInventory cci;

	public GuiCatalystTierQuintridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci) {
	    super(new ContainerCatalystTierQuintridium(playerInv, cci));
