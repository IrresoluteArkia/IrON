...
public class CraftingTierQuadridium {

	private static final CraftingTierQuadridium instance = new CraftingTierQuadridium();
	public ArrayList<RecipeCatalyst> recipes = new ArrayList<RecipeCatalyst>();
	
	public CraftingTierQuadridium(){
	...
	public static ItemStack getMatchingRecipeResult(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierTriridium.getMatchingRecipeResult(ingredients);
	}
	...
	public static IRecipe getMatchingRecipe(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierTriridium.getMatchingRecipe(ingredients);
	}
	...
	public static CraftingTierQuadridium getInstance(){
		return instance;
	}
