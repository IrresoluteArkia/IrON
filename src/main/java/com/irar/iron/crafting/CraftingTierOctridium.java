...
public class CraftingTierOctridium {

	private static final CraftingTierOctridium instance = new CraftingTierOctridium();
	public ArrayList<RecipeCatalyst> recipes = new ArrayList<RecipeCatalyst>();
	
	public CraftingTierOctridium(){
	...
	public static ItemStack getMatchingRecipeResult(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierSeptridium.getMatchingRecipeResult(ingredients);
	}
	...
	public static IRecipe getMatchingRecipe(ArrayList<ItemStack> ingredients){
		...
		return CraftingTierSeptridium.getMatchingRecipe(ingredients);
	}
	...
	public static CraftingTierOctridium getInstance(){
		return instance;
	}
