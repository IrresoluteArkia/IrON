...
public class ContainerCatalystTierBiridium extends Container{

	private ItemCatalyst.CatalystCraftingInventory cci;
	
	public ContainerCatalystTierBiridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci){
