...
public class WorldGenOre implements IWorldGenerator{
	...
	private void genNether(World world, Random random, int chunkX, int chunkZ){
		addOreSpawn(BlockHandler.NetherIrONOre.getDefaultState(), world, random, chunkX, chunkZ, 16, 16, 20, 50, 50, 60,  BlockMatcher.forBlock(Blocks.NETHERRACK));
	}
