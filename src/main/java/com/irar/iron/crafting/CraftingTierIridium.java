...
public class CraftingTierIridium {

	private static final CraftingTierIridium instance = new CraftingTierIridium();
	public ArrayList<RecipeCatalyst> recipes = new ArrayList<RecipeCatalyst>();
	
	public CraftingTierIridium(){
	...
	public static CraftingTierIridium getInstance(){
		return instance;
	}
