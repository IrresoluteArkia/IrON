...
public class ContainerCatalystTierIridium extends Container{

	private ItemCatalyst.CatalystCraftingInventory cci;
	
	public ContainerCatalystTierIridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci){
