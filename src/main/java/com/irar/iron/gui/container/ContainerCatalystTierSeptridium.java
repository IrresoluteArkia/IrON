...
public class ContainerCatalystTierSeptridium extends Container{

	private ItemCatalyst.CatalystCraftingInventory cci;
	
	public ContainerCatalystTierSeptridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci){
