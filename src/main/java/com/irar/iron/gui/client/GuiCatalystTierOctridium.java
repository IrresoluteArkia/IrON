...
public class GuiCatalystTierOctridium extends GuiContainer {

	private IInventory playerInv;
	private ItemCatalyst.CatalystCraftingInventory cci;

	public GuiCatalystTierOctridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci) {
	    super(new ContainerCatalystTierOctridium(playerInv, cci));
