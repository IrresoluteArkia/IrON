...
public class ContainerCatalystTierQuintridium extends Container{

	private ItemCatalyst.CatalystCraftingInventory cci;
	
	public ContainerCatalystTierQuintridium(InventoryPlayer playerInv, ItemCatalyst.CatalystCraftingInventory cci){
